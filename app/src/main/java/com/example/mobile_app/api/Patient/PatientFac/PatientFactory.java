...
abstract public class PatientFactory implements PatientFacInter {
    ...
    public Patient createPatient(String name, String sex, String address, String phoneNumber, String id, MedRecord medicalRecord, String healthInsuranceID, String bloodType, String occupation, String nationality, String religion, String birth, String age, boolean insuranceType) {
